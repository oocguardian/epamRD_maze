...
public class Maze50 {
    ...
    public static void main(String[] args) {
        int width  = 693;
        int height = 545;
        mazeFrame = new JFrame("com.epam.trash.Maze 5.0");
...
         * obstacles or move the robot and/or target.
        ...
        private class ActionHandler implements ActionListener {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                if (cmd.equals("Clear")) {
                    ...
                    timer.start();
                } else if (cmd.equals("About com.epam.trash.Maze")) {
        ...
        private class AboutBox extends JDialog{
            ...
            public AboutBox(Frame parent, boolean modal){
                ...
                JLabel title = new JLabel("com.epam.trash.Maze", JLabel.CENTER);
                title.setFont(new Font("Helvetica",Font.PLAIN,24));
                title.setForeground(new Color(255, 153, 102));
        ...
        } // end nested class com.epam.trash.MyMaze
        ...
        public MazePanel(int width, int height) {
            ...
            mazeButton = new JButton("com.epam.trash.Maze");
            ...
            algoPanel.setBorder(BorderFactory.
                    createTitledBorder(BorderFactory.createEtchedBorder(),
                    "Algorithms", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
                    javax.swing.border.TitledBorder.TOP, new Font("Helvetica", 0, 14)));
            ...
            JButton aboutButton = new JButton("About com.epam.trash.Maze");
    ...
    static protected JSpinner addLabeledSpinner(Container c,
        ...
        /**
         * Function executed if the user presses the button "com.epam.trash.Maze"
         */
        private void mazeButtonActionPerformed(ActionEvent evt) {
            realTime = false;
            realTimeButton.setEnabled(true);
            realTimeButton.setForeground(Color.black);
            stepButton.setEnabled(true);
